...
def init_db():
    ...
    if c.execute("SELECT COUNT(*) FROM orders").fetchone()[0] == 0:
        orders = [
            ("ORD-001","H001","Lilavati Hospital","MicroQuark USB Spirometer",2,"2026-01-05","Delivered",180000,""),
            ("ORD-002","H002","Kokilaben Hospital","Suction Machine - Dominant Flex",3,"2026-01-12","Delivered",96000,""),
            ("ORD-003","H003","Fortis Healthcare","AED Plus (ZOLL)",2,"2026-01-18","Delivered",300000,""),
            ("ORD-004","H004","Nanavati Hospital","Scoop Stretcher (Spencer)",5,"2026-02-01","Delivered",125000,""),
            ("ORD-005","H001","Lilavati Hospital","Rad-97 Table-top Pulse Oximeter",8,"2026-02-10","Delivered",320000,""),
            ("ORD-006","H006","Wockhardt Hospital","Steam Sterilizer (Belimed)",1,"2026-02-14","Delivered",850000,""),
            ("ORD-007","H007","HN Reliance Hospital","Suction Machine - Vario-18",4,"2026-02-20","Delivered",120000,""),
            ("ORD-008","H002","Kokilaben Hospital","Autopulse NXT (ZOLL)",1,"2026-03-01","Delivered",650000,""),
            ("ORD-009","H003","Fortis Healthcare","Rad-G Handheld Pulse Oximeter",5,"2026-03-05","Delivered",110000,""),
            ("ORD-010","H004","Nanavati Hospital","Rad-97 with NIBP Pulse Oximeter",3,"2026-03-08","Delivered",165000,""),
            ("ORD-011","H005","Breach Candy Hospital","AED 3 (ZOLL)",2,"2026-03-12","Delivered",320000,""),
            ("ORD-012","H007","HN Reliance Hospital","Rad-97 Table-top Pulse Oximeter",3,"2026-03-15","Delivered",120000,""),
            ("ORD-013","H001","Lilavati Hospital","911 Emergency Backpack",5,"2026-03-18","Delivered",42500,""),
            ("ORD-014","H006","Wockhardt Hospital","EMMA Capnograph (Masimo)",1,"2026-03-22","Delivered",95000,""),
            ("ORD-015","H002","Kokilaben Hospital","MicroQuark USB Spirometer",1,"2026-03-28","Delivered",90000,""),
            ("ORD-016","H001","Lilavati Hospital","AED Plus (ZOLL)",1,"2026-04-02","Dispatched",150000,""),
            ("ORD-017","H003","Fortis Healthcare","Suction Machine - Dominant Flex",2,"2026-04-04","Dispatched",64000,""),
            ("ORD-018","H004","Nanavati Hospital","Rad-97 with NIBP Pulse Oximeter",3,"2026-04-07","Processing",165000,""),
            ("ORD-019","H002","Kokilaben Hospital","Scoop Stretcher (Spencer)",4,"2026-04-09","Processing",100000,""),
            ("ORD-020","H005","Breach Candy Hospital","Autopulse NXT (ZOLL)",1,"2026-04-11","Received",650000,""),
            ("ORD-021","H007","HN Reliance Hospital","AED 3 (ZOLL)",2,"2026-04-14","Received",320000,""),
            ("ORD-022","H006","Wockhardt Hospital","Rad-G Handheld Pulse Oximeter",6,"2026-04-16","Processing",132000,""),
            ("ORD-023","H001","Lilavati Hospital","Steam Sterilizer (Belimed)",1,"2026-04-18","Received",850000,""),
            ("ORD-024","H003","Fortis Healthcare","911 Emergency Backpack",8,"2026-04-20","Dispatched",68000,""),
            ("ORD-025","H004","Nanavati Hospital","MicroQuark USB Spirometer",1,"2026-04-23","Received",90000,""),
            ("ORD-026","H002","Kokilaben Hospital","ROOT Monitor (Masimo)",1,"2026-04-25","Processing",180000,""),
            ("ORD-027","H005","Breach Candy Hospital","Suction Machine - Vario-18",3,"2026-04-27","Received",84000,""),
            ("ORD-028","H007","HN Reliance Hospital","EMMA Capnograph (Masimo)",2,"2026-04-29","Received",190000,""),
        ]
    ...
    if c.execute("SELECT COUNT(*) FROM tickets").fetchone()[0] == 0:
        tickets = [
            ("SRV-001","H001","Lilavati Hospital","AED Plus (ZOLL)","Electrode pads worn out","High","","2026-01-08","Rahul Patil","Resolved"),
            ("SRV-002","H002","Kokilaben Hospital","Rad-97 Table-top Pulse Oximeter","Display flickering","Medium","","2026-01-15","Sameer Joshi","Resolved"),
            ("SRV-003","H003","Fortis Healthcare","AED Plus (ZOLL)","Battery not charging","High","","2026-01-22","Rahul Patil","Resolved"),
            ("SRV-004","H004","Nanavati Hospital","Steam Sterilizer (Belimed)","Temperature alarm triggering","High","","2026-02-03","Priya Nair","Resolved"),
            ("SRV-005","H006","Wockhardt Hospital","Autopulse NXT (ZOLL)","Belt alignment issue","Medium","","2026-02-10","Sameer Joshi","Resolved"),
            ("SRV-006","H002","Kokilaben Hospital","Rad-97 Table-top Pulse Oximeter","SpO2 sensor inaccurate","Medium","","2026-02-14","Rahul Patil","Resolved"),
            ("SRV-007","H005","Breach Candy Hospital","Rad-97 with NIBP Pulse Oximeter","Rainbow SpO2 sensor damaged","High","","2026-02-20","Priya Nair","Resolved"),
            ("SRV-008","H003","Fortis Healthcare","ROOT Monitor (Masimo)","NIBP hose assembly leaking","Medium","","2026-03-02","Sameer Joshi","Resolved"),
            ("SRV-009","H007","HN Reliance Hospital","Suction Machine - Dominant Flex","Motor noise during operation","Medium","","2026-03-08","Rahul Patil","Resolved"),
            ("SRV-010","H001","Lilavati Hospital","MicroQuark USB Spirometer","Flow sensor reading off","Low","","2026-03-12","Priya Nair","Resolved"),
            ("SRV-011","H004","Nanavati Hospital","Scoop Stretcher (Spencer)","Wheel and axle broken","Medium","","2026-03-18","Sameer Joshi","Resolved"),
            ("SRV-012","H006","Wockhardt Hospital","AED 3 (ZOLL)","Printer paper jam","Low","","2026-03-25","Rahul Patil","Resolved"),
            ("SRV-013","H002","Kokilaben Hospital","Suction Machine - Vario-18","Canister seal leaking","Medium","","2026-04-02","Sameer Joshi","Resolved"),
            ("SRV-014","H001","Lilavati Hospital","AED Plus (ZOLL)","Battery pack not holding charge","High","","2026-04-05","Rahul Patil","In Progress"),
            ("SRV-015","H003","Fortis Healthcare","Rad-97 with NIBP Pulse Oximeter","NIBP cuff not inflating","Medium","","2026-04-08","Priya Nair","In Progress"),
            ("SRV-016","H005","Breach Candy Hospital","EMMA Capnograph (Masimo)","CO2 sensor calibration off","Medium","","2026-04-12","Sameer Joshi","Assigned"),
            ("SRV-017","H007","HN Reliance Hospital","Scoop Stretcher (Spencer)","Fastening belt worn out","Low","","2026-04-15","Unassigned","Reported"),
            ("SRV-018","H004","Nanavati Hospital","Steam Sterilizer (Belimed)","Door gasket needs replacement","High","","2026-04-18","Rahul Patil","Assigned"),
            ("SRV-019","H006","Wockhardt Hospital","MicroQuark USB Spirometer","Mouthpiece adapter broken","Low","","2026-04-22","Unassigned","Reported"),
            ("SRV-020","H002","Kokilaben Hospital","Autopulse NXT (ZOLL)","Device not powering on","High","","2026-04-25","Rahul Patil","In Progress"),
        ]
